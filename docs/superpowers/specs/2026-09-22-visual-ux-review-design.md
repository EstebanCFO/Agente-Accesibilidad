...
- `createToolRegistry({ jobStore, anthropicClient })` gana un segundo parámetro obligatorio; los handlers de las dos tools nuevas delegan en `runVisualAudit`/`runUxComplianceReview` pasando ese cliente.
